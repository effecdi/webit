  ...
  return (
    <>
      ...
      <div className="px-8 py-14" style={{ backgroundColor: sectionBg2, fontFamily }}>
        ...
        <div className="h-[200px] flex items-center justify-center mb-4 relative overflow-hidden border-double border-4" style={{ borderColor: accent, backgroundColor: cardBg }}>
