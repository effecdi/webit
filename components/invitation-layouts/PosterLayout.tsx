  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundColor: sectionBg2 }}
      >
        <FlowerDaisy
          color="#F4C7AB"
          size={22}
        ...
        {data.invitationTitle && (
          <p
            ...
            style={{ color: textPrimary, fontFamily: sansFont }}
          >
            {data.invitationTitle}
          </p>
        )}
            ...
            const groomBlock = (
              ...
              >
                {data.groomFather?.name && (
                  <>
                    <DeceasedMark show={data.groomFather.deceased} />
                    {data.groomFather.name}
                  </>
                )}
                {data.groomMother?.name && (
                  <>
                    {" "}
                    · <DeceasedMark show={data.groomMother.deceased} />
                    {data.groomMother.name}
                  </>
                )}
            ...
            const brideBlock = (
              ...
              >
                {data.brideFather?.name && (
                  <>
                    <DeceasedMark show={data.brideFather.deceased} />
                    {data.brideFather.name}
                  </>
                )}
                {data.brideMother?.name && (
                  <>
                    {" "}
                    · <DeceasedMark show={data.brideMother.deceased} />
                    {data.brideMother.name}
                  </>
                )}
      ...
      {(data.showCalendar || data.showCountdown) &&
        data.weddingDate &&
        (() => {
            ...
            >
              ...
              <div className="text-center mb-6">
                <p
                  ...
                  style={{ color: textPrimary, fontFamily: serifFont }}
                >
                  {helpers.formatWeddingDate()}
                </p>
                <p
                  className="text-[12px] mt-1"
                  style={{ color: textSecondary, fontFamily: sansFont }}
                >
              ...
              {data.showCalendar && calStyle === "full" && (
                <div
                  ...
                  style={{ backgroundColor: pageBg, borderRadius: "12px" }}
                >
                  <div className="grid grid-cols-7 gap-0 mb-2">
                    {cal.dayNames.map((d) => (
                      <div
                        ...
                        style={{ color: accent, fontFamily: sansFont }}
                      >
                        {d}
                      </div>
                    ))}
              ...
              {data.showCalendar && calStyle === "simple" && (
                ...
                >
                  <p
                    ...
                    style={{ color: textPrimary, fontFamily: serifFont }}
                  >
                    {cal.year}년 {cal.month}월 {cal.weddingDay}일{" "}
                    {cal.weddingDayName}요일
                  </p>
                  <p
                    className="text-[12px] mt-1"
                    style={{ color: textSecondary, fontFamily: sansFont }}
                      ...
                      <div className="text-center">
                        ...
                        >
                          <p
                            ...
                            style={{ color: accent, fontFamily: serifFont }}
                          >
                            {item.value}
                          </p>
                        </div>
      ...
      <div
        className="px-8 py-14 relative"
        style={{ backgroundColor: sectionBg1 }}
      >
        <FlowerDaisy
          color="#FFFFFF"
          size={20}
        ...
        {data.transportItems &&
          data.transportItems.some((t) => t.type || t.detail) && (
            <div className="mt-6 space-y-4">
              {data.transportItems
                .filter((t) => t.type || t.detail)
                .map((item, i) => (
                  <div
                    key={i}
                    className="p-4"
                    style={{ backgroundColor: sectionBg2, borderRadius: "8px" }}
                  >
                    {item.type && (
                      <p
      ...
      {data.showFunding && (
        ...
        >
          ...
          <p
            ...
            style={{ color: textSecondary, fontFamily: sansFont }}
          >
            축하의 마음을 전하는 방법에는 여러 가지가 있습니다. 신랑·신부에게
            직접 마음을 전하고 싶으신 분들을 위해 현금 펀딩을 준비했습니다.
          </p>
        </div>
      )}
        ...
        (() => {
          ...
          const groomAccList =
            data.groomFatherAccount?.account || data.groomMotherAccount?.account
              ? [data.groomFatherAccount, data.groomMotherAccount].filter(
                  (a) => a?.account,
                )
              : data.groomAccounts?.filter((a) => a?.account) || [];
          const brideAccList =
            data.brideFatherAccount?.account || data.brideMotherAccount?.account
              ? [data.brideFatherAccount, data.brideMotherAccount].filter(
                  (a) => a?.account,
                )
      ...
      {data.showNotice && data.noticeTitle && (
        ...
        >
          ...
          <div
            className="p-5"
            style={{ backgroundColor: sectionBg2, borderRadius: "10px" }}
          >
      ...
      {data.showEndingMessage &&
        (data.endingContent || data.endingPhoto) &&
        (() => {
                  ...
                  {data.endingContent && (
                    <div className="absolute inset-0 flex items-center justify-center px-8">
                      <p
                        ...
                        style={{ color: endTextColor, fontFamily: sansFont }}
                      >
                        {data.endingContent}
                      </p>
                    </div>
