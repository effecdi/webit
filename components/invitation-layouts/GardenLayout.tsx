  ...
  return (
    <>
      ...
      <div className="px-8 py-14" style={{ backgroundColor: sectionBg1 }}>
        ...
        <div className="rounded-2xl h-[200px] flex items-center justify-center mb-4 relative overflow-hidden" style={{ backgroundColor: sectionBg2, border: `1px solid ${borderColor}` }}>
          <div className="text-center">
            ...
            <p className="text-[12px]" style={{ color: rosyBrown }}>지도 영역</p>
          </div>
        </div>
