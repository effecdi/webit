...
export function CinematicLayout({ data, state, helpers }: LayoutProps) {
  ...
  return (
    <>
      ...
      <div className="px-8 py-14" style={{ backgroundColor: sectionBg2, fontFamily }}>
        ...
        <div className="rounded-[16px] h-[200px] flex items-center justify-center mb-4 relative overflow-hidden" style={{ backgroundColor: cardBg }}>
