...
const INITIAL_TODOS: TodoItem[] = [
  ...
  },
  {
    ...
    completed: true,
    assignee: "me",
    comments: [{ id: "c3", author: "you", text: "뭐 사줄거야?", time: "어제" }],
  },
  {
    id: "3",
    text: "영화 예매하기",
      ...
      <main className="pt-16 px-5 space-y-4 max-w-md mx-auto">
        ...
        <div className="mt-2 flex justify-between items-start">
          ...
          <div className="flex flex-col items-end gap-2">
            {/* ✨ [변경됨] 프로필 아바타 영역: 선택한 이모지가 여기에 반영됨 */}
        ...
        <div className="bg-white rounded-[24px] p-5 shadow-toss">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="font-bold text-[19px] text-[#191F28] mb-1">
                다가오는 기념일
              </h3>
