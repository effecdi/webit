...
export default function WelcomePage() {
  ...
  useEffect(() => {
    ...
    const savedPartnerName =
      localStorage.getItem("survey_partnerName") || "상대방";
        ...
        return (
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              <span className="text-[32px] font-bold text-[#d63bf2]">
                {myName}
              </span>
              <Heart className="w-8 h-8 text-pink-500 fill-pink-500 animate-pulse" />
              <span className="text-[32px] font-bold text-pink-500">
                {partnerName}
              </span>
              <span className="text-[32px] font-bold text-[#191F28]">
                님 :)
              </span>
            </div>
          </div>
      ...
      case 1:
        return (
          <div className="text-center">
            ...
            <p className="text-[48px] font-extrabold text-[#d63bf2] my-4">
              {formatNumber(daysTogether)}일
            </p>
            <p className="text-[28px] font-bold text-[#191F28]">이 되었네요!</p>
          </div>
        );
      case 2:
        return (
          ...
          <div className="text-center">
            ...
            <div className="mt-8">
              <div className="w-16 h-16 bg-[#F3E8FF] rounded-full flex items-center justify-center mx-auto animate-bounce">
                <Heart className="w-8 h-8 text-[#d63bf2] fill-[#d63bf2]" />
              </div>
            </div>
          </div>
        );
