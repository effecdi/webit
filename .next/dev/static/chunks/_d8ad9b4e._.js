...
function FamilyCoupleProfile() {
    ...
    const [weddingDateStr, setWeddingDateStr] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("날짜 미정");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FamilyCoupleProfile.useEffect": ()=>{
            const savedWeddingDate = localStorage.getItem("wedding_date") || "2025-12-20";
            const wd = new Date(savedWeddingDate);
            const t = new Date();
            setDaysTogether(Math.floor((t.getTime() - wd.getTime()) / (1000 * 60 * 60 * 24)));
            setWeddingDateStr(`${wd.getFullYear()}.${String(wd.getMonth() + 1).padStart(2, "0")}.${String(wd.getDate()).padStart(2, "0")}`);
        }
    }["FamilyCoupleProfile.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FamilyCoupleProfile.useEffect": ()=>{
            ...
            fetch("/api/couple").then({
                "FamilyCoupleProfile.useEffect": (res)=>res.json()
            }["FamilyCoupleProfile.useEffect"]).then({
                "FamilyCoupleProfile.useEffect": (data)=>{
                    setIsCoupled(data.coupled === true);
                    if (data.coupled && data.partner) {
                        const pName = data.partner.firstName || partnerName;
                        setProfiles({
                            "FamilyCoupleProfile.useEffect": (prev)=>({
                                    ...prev,
                                    partner: {
                                        ...prev.partner,
                                        name: pName,
                    ...
                    if (!data.coupled) {
                        fetch("/api/couple-invite").then({
                            "FamilyCoupleProfile.useEffect": (r)=>r.json()
                        }["FamilyCoupleProfile.useEffect"]).then({
                            "FamilyCoupleProfile.useEffect": (invData)=>{
                                if (invData.invites) {
                                    const pending = invData.invites.find({
                                        "FamilyCoupleProfile.useEffect.pending": (inv)=>inv.mode === "family" && inv.status === "pending"
                                    }["FamilyCoupleProfile.useEffect.pending"]);
                                    if (pending) setInviteCode(pending.inviteCode);
                                }
                            }
                        }["FamilyCoupleProfile.useEffect"]).catch({
                            "FamilyCoupleProfile.useEffect": ()=>{}
                        }["FamilyCoupleProfile.useEffect"]);
                    }
                }
    ...
    const handleKakaoShare = ()=>{
        ...
        const senderName = profiles.me.name || "상대방";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            ...
            isCoupled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mb-4 px-3 py-2 bg-green-50 rounded-[10px] flex items-center gap-2",
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "text-[12px] text-green-600 font-semibold",
                        children: "커플 연결 완료"
                    }, void 0, false, {
                        fileName: "[project]/components/family/family-couple-profile.tsx",
                        lineNumber: 215,
...
_s(FamilyCoupleProfile, "8Mi4vn2/SRjY51mr/5cCwLoF1aw=");
...
//# sourceMappingURL=_d8ad9b4e._.js.map