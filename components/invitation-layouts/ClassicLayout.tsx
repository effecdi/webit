...
export function ClassicLayout({ data, state, helpers }: LayoutProps) {
  const pageBg = "#F5F5F0"
  ...
  return (
    <>
      {/* ===== HERO SECTION ===== */}
      <div className="py-14 px-8" style={{ backgroundColor: sectionBg1 }}>
        <div className="flex flex-col items-center">
          ...
          {state.allPhotos.length > 0 ? (
            <div className="w-full max-w-[300px] mt-4">
              <div className="relative overflow-hidden rounded-t-[100px] rounded-b-lg aspect-[3/4]">
                {coverStyle === "static" ? (
            ...
            <div className="w-full max-w-[300px] mt-4">
              <div className="rounded-t-[100px] rounded-b-lg aspect-[3/4] flex items-center justify-center" style={{ backgroundColor: cardBg, border: `1px solid ${borderColor}` }}>
                <p className="text-[14px]" style={{ color: textSecondary }}>사진을 추가해주세요</p>
              </div>
            </div>
          )}

          <div className="w-12 h-[1px] mx-auto mt-8 mb-4" style={{ backgroundColor: accent, opacity: 0.5 }} />

          <p className="text-[22px] font-medium" style={{ color: textPrimary, fontFamily: serif }}>
            {data.groomName || "신랑"} <span className="font-light text-[16px] mx-2" style={{ color: textSecondary }}>&</span> {data.brideName || "신부"}
          </p>

          <div className="w-12 h-[1px] mx-auto mt-4 mb-4" style={{ backgroundColor: accent, opacity: 0.5 }} />
            ...
            <div className="grid grid-cols-3 gap-2">
              {state.galleryImages.map((img, index) => (
                <div
                  ...
                  style={{ border: `1px solid ${borderColor}`, boxShadow: "0 2px 8px rgba(139,123,107,0.1)" }}
        ...
        return (
          <div className="px-8 py-14 text-center" style={{ backgroundColor: sectionBg1 }}>
            ...
            {data.showCalendar && calStyle === "full" && (
              <div className="mb-8 mx-auto max-w-[320px] p-4 rounded-2xl" style={{ backgroundColor: cardBg }}>
      ...
      <div className="px-8 py-14" style={{ backgroundColor: sectionBg1 }}>
        ...
        <div className="rounded-2xl h-[200px] flex items-center justify-center mb-4 relative overflow-hidden" style={{ backgroundColor: cardBg, border: `1px solid ${borderColor}` }}>
        ...
        <button
          ...
          style={{ border: `1px solid ${borderColor}`, color: textPrimary, backgroundColor: cardBg }}
        ...
        {data.showTransportNotice && (
          <div className="mt-6 p-4 rounded-2xl" style={{ backgroundColor: cardBg, border: `1px solid ${borderColor}` }}>
      ...
      {data.showRsvp && (
        <div className="px-8 py-14" style={{ backgroundColor: sectionBg2 }}>
          ...
          <div className="flex justify-center mb-6">
            <div className="py-5 px-10 rounded-2xl" style={{ backgroundColor: sectionBg1, border: `1px solid ${borderColor}` }}>
      ...
      {data.showGuestbook && (
        <div className="px-8 py-14" style={{ backgroundColor: sectionBg1 }}>
          ...
          {state.showGuestbookForm ? (
            <div className="p-5 rounded-2xl mb-4" style={{ backgroundColor: cardBg, border: `1px solid ${borderColor}` }}>
              <input
                type="text"
                ...
                style={{ border: `1px solid ${borderColor}`, backgroundColor: "#FBF8F1", color: textPrimary }}
      ...
      {data.showNotice && data.noticeTitle && (
        <div className="px-8 py-14" style={{ backgroundColor: sectionBg2 }}>
          ...
          <p className="text-[18px] font-medium text-center mb-4" style={{ color: accent, fontFamily: handwriting }}>{data.noticeTitle}</p>
        ...
        return (
          <div className="px-8 py-14" style={{ backgroundColor: sectionBg1 }}>
            ...
            {eStyle === "card" && data.endingPhoto && (
              <div className="mx-auto max-w-[280px] mb-6 rounded-2xl overflow-hidden" style={{ border: `1px solid ${borderColor}` }}>
                <img
