        ...
        <div className="px-5 py-5 space-y-5 max-h-[70vh] overflow-y-auto">
          ...
          <div className="flex gap-3 pt-2 pb-4">
            <button
              ...
              className="flex-none px-5 py-4 rounded-[14px] bg-[#F2F4F6] text-red-500 font-semibold text-[15px] hover:bg-red-50 transition-colors"
            >
              삭제
            </button>
            <button
              ...
              className={`flex-1 py-4 rounded-[14px] font-semibold text-[16px] transition-all ${
                editForm.title
